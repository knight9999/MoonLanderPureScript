...
})(PS["MatchMedia"] = PS["MatchMedia"] || {});
(function($PS) {
  // Generated by purs version 0.14.0
  "use strict";
  $PS["MatchMedia"] = $PS["MatchMedia"] || {};
  var exports = $PS["MatchMedia"];
  var $foreign = $PS["MatchMedia"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Data_Foldable = $PS["Data.Foldable"];
  var Data_Maybe = $PS["Data.Maybe"];
  var Data_Unit = $PS["Data.Unit"];
  ...
  var Halogen_Subscription = $PS["Halogen.Subscription"];
  var Web_Event_EventTarget = $PS["Web.Event.EventTarget"];                
  var fromEvent = function ($0) {
      return Data_Maybe.Just.create($0);
  };
  var eventListener = function (mm) {
      return function (f) {
          return Halogen_Subscription.makeEmitter(function (push) {
              return function __do() {
                  var listener = Web_Event_EventTarget.eventListener(function (mm$prime) {
                      return Data_Foldable.traverse_(Effect.applicativeEffect)(Data_Foldable.foldableMaybe)(push)(f(mm$prime));
                  })();
                  $foreign.addListener(listener)(mm)();
                  $foreign.callListener(listener)(mm)();
                  return Control_Applicative.pure(Effect.applicativeEffect)(Data_Unit.unit);
              };
          });
      };
  ...
  exports["getMatchMedia"] = $foreign.getMatchMedia;
...
(function($PS) {
  // Generated by purs version 0.14.0
  "use strict";
  $PS["Web.TouchEvent.TouchEvent"] = $PS["Web.TouchEvent.TouchEvent"] || {};
  var exports = $PS["Web.TouchEvent.TouchEvent"];
  var Unsafe_Coerce = $PS["Unsafe.Coerce"];
...
(function($PS) {
  ...
  var Web_HTML_Window = $PS["Web.HTML.Window"];
  var Web_TouchEvent_EventTypes = $PS["Web.TouchEvent.EventTypes"];
  ...
  var HandleDown = (function () {
      ...
      HandleDown.value = new HandleDown();
      return HandleDown;
  })();
  ...
  var HandleTouchStart = (function () {
      function HandleTouchStart(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandleTouchStart.create = function (value0) {
          return function (value1) {
              return new HandleTouchStart(value0, value1);
          };
      };
      return HandleTouchStart;
  })();
  var HandleTouchEnd = (function () {
      function HandleTouchEnd(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      HandleTouchEnd.create = function (value0) {
          return function (value1) {
              return new HandleTouchEnd(value0, value1);
          };
      };
      return HandleTouchEnd;
  })();
  var MediaTypeChanged = (function () {
      function MediaTypeChanged(value0, value1) {
          this.value0 = value0;
          this.value1 = value1;
      };
      MediaTypeChanged.create = function (value0) {
          return function (value1) {
              return new MediaTypeChanged(value0, value1);
          };
      };
      return MediaTypeChanged;
  })();
      ...
      var wrappedFn = function (done) {
          return function __do() {
              Graphics_Canvas.tryLoadImage(path)(function (maybeImage) {
                  ...
                  throw new Error("Failed pattern match at MoonLander (line 535, column 44 - line 537, column 67): " + [ maybeImage.constructor.name ]);
              })();
  ...
  var explain = Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("class")("explain") ])([ Halogen_HTML_Elements.h2([  ])([ Halogen_HTML_Core.text("\u904a\u3073\u65b9") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("\u30b9\u30da\u30fc\u30b9\u30ad\u30fc\u3092\u62bc\u3059\u3068\u3001\u30ed\u30b1\u30c3\u30c8\u304c\u4e0a\u65b9\u306b\u52a0\u901f\u3057\u307e\u3059\u3002") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("\u30b9\u30da\u30fc\u30b9\u30ad\u30fc\u3092\u96e2\u3059\u3068\u3068\u3001\u30ed\u30b1\u30c3\u30c8\u304c\u91cd\u529b\u306b\u5f15\u304b\u308c\u3066\u843d\u4e0b\u3057\u59cb\u3081\u307e\u3059\u3002") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("\u7de9\u3084\u304b\u306a\u901f\u5ea6(-2.0 km/h \u4ee5\u4e0a)\u3067\u7740\u9678\u3059\u308c\u3070\u6210\u529f\u3067\u3059\u3002") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("\u6ce8\u610f\uff1a\u30b9\u30de\u30db\u306e\u5834\u5408\u3001\u753b\u9762\u3092\u30bf\u30c3\u30d7\u3059\u308b\u3068\u30ed\u30b1\u30c3\u30c8\u304c\u4e0a\u6607\u3057\u307e\u3059\u3002") ]), Halogen_HTML_Elements.h3([  ])([ Halogen_HTML_Core.text("\u753b\u50cf\u30d5\u30a1\u30a4\u30eb") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("\u30ed\u30b1\u30c3\u30c8\u753b\u50cf(rocket.png)"), Halogen_HTML_Elements.br([  ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.attr("href")("https://www.kenney.nl/assets"), Halogen_HTML_Properties.attr("target")("_blank") ])([ Halogen_HTML_Core.text("(C) KENNEY") ]) ]), Halogen_HTML_Elements.h3([  ])([ Halogen_HTML_Core.text("\u53c2\u8003\u30d7\u30ed\u30b0\u30e9\u30e0 (Python)") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Core.text("\u65e5\u7d4c\u30bd\u30d5\u30c8\u30a6\u30a7\u30a2 2020\u5e745\u6708\u53f7\u3000\u7b2c\uff12\u4ed8\u9332"), Halogen_HTML_Elements.br([  ]), Halogen_HTML_Elements.a([ Halogen_HTML_Properties.attr("href")("http://bizboard.nikkeibp.co.jp/kijiken/summary/20200324/NSW0269F_4688963a.html"), Halogen_HTML_Properties.attr("target")("_blank") ])([ Halogen_HTML_Core.text("5\u65e5\u3067\u3067\u304d\u308b\uff01 Python\u3067\u30b2\u30fc\u30e0\u4f5c\u6210\u5165\u9580\uff0f\u7b2c\u56db\u65e5\u76ee") ]) ]), Halogen_HTML_Elements.h3([  ])([ Halogen_HTML_Core.text("Github") ]), Halogen_HTML_Elements.div([  ])([ Halogen_HTML_Elements.a([ Halogen_HTML_Properties.attr("href")("https://github.com/knight9999/MoonLanderPureScript"), Halogen_HTML_Properties.attr("target")("_blank") ])([ Halogen_HTML_Core.text("https://github.com/knight9999/MoonLanderPureScript") ]) ]) ]);
  var render = function (dictMonadEffect) {
      return function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.attr("style")("display: inline-block") ])([ Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id_()("canvas"), Halogen_HTML_Properties.width(state.canvas.width), Halogen_HTML_Properties.height(state.canvas.height), Halogen_HTML_Properties.style("width:" + ((function () {
              if (state.env.isMobile) {
                  return Data_Int.toStringAs(Data_Int.decimal)(state.env.width);
              };
              return Data_Int.toStringAs(Data_Int.decimal)(state.canvas.width);
          })() + ("px; height: " + ((function () {
              if (state.env.isMobile) {
                  return Data_Int.toStringAs(Data_Int.decimal)(state.env.height);
              };
              return Data_Int.toStringAs(Data_Int.decimal)(state.canvas.height);
          })() + "px;")))) ]), Halogen_HTML_Elements.canvas([ Halogen_HTML_Properties.id_()("hidden_canvas"), Halogen_HTML_Properties.width(state.canvas.width), Halogen_HTML_Properties.height(state.canvas.height), Halogen_HTML_Properties.attr("style")("display: none") ]) ]), explain ]);
      };
  };
  ...
  var handleAction = function (dictMonadAff) {
      return function (dictMonadEffect) {
          return function (v) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Control_Bind.bind(Effect_Aff.bindAff)(tryLoadImageAff("images/rocket.png"))(function (rocket_src$prime) {
                          ...
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              ...
                              $47.images = (function () {
                                  var $44 = {};
                                  for (var $45 in st.images) {
                                      if ({}.hasOwnProperty.call(st.images, $45)) {
                                          $44[$45] = st["images"][$45];
                                      };
                                  };
                                  $44.rocket = new Data_Maybe.Just(rocket_src);
                                  return $44;
                              })();
                              return $47;
                          }))(function () {
                              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(function __do() {
                                  var mm = MatchMedia.getMatchMedia("screen and (max-width: 480px)")();
                                  return mm;
                              }))(function (mm) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                                      return MatchMedia.eventListener(mm)((function () {
                                          var $143 = Data_Functor.map(Data_Maybe.functorMaybe)(MediaTypeChanged.create(sid));
                                          return function ($144) {
                                              return $143(MatchMedia.fromEvent($144));
                                          };
                                      })());
                                  }))(function () {
                                                  ...
                                                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window)))(function (document) {
                                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                                                          return Halogen_Query_Event.eventListener(Web_UIEvent_KeyboardEvent_EventTypes.keydown)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                                                              var $145 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyDown.create(sid));
                                                              return function ($146) {
                                                                  return $145(Web_UIEvent_KeyboardEvent.fromEvent($146));
                                                              };
                                                          })());
                                                      }))(function () {
                                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                                                              return Halogen_Query_Event.eventListener(Web_UIEvent_KeyboardEvent_EventTypes.keyup)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                                                                  var $147 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleKeyUp.create(sid));
                                                                  return function ($148) {
                                                                      return $147(Web_UIEvent_KeyboardEvent.fromEvent($148));
                                                                  };
                                                              })());
                                                          }))(function () {
                                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                                                                  return Halogen_Query_Event.eventListener(Web_TouchEvent_EventTypes.touchstart)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                                                                      var $149 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleTouchStart.create(sid));
                                                                      return function ($150) {
                                                                          return $149(Web_TouchEvent_TouchEvent.fromEvent($150));
                                                                      };
                                                                  })());
                                                              }))(function () {
                                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM["subscribe'"](function (sid) {
                                                                      return Halogen_Query_Event.eventListener(Web_TouchEvent_EventTypes.touchend)(Web_HTML_HTMLDocument.toEventTarget(document))((function () {
                                                                          var $151 = Data_Functor.map(Data_Maybe.functorMaybe)(HandleTouchEnd.create(sid));
                                                                          return function ($152) {
                                                                              return $151(Web_TouchEvent_TouchEvent.fromEvent($152));
                                                                          };
                                                                      })());
                                                                  }))(function () {
              ...
              if (v instanceof MediaTypeChanged) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
                      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(function __do() {
                          var matches$prime = MatchMedia.matches(v.value1)();
                          ...
                          var maybeBody = Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_HTMLDocument.body)(Control_Bind.bindFlipped(Effect.bindEffect)(Web_HTML_Window.document)(Web_HTML.window))();
                          var v1 = Data_Functor.map(Data_Maybe.functorMaybe)(Web_HTML_HTMLElement.toElement)(maybeBody);
                          if (v1 instanceof Data_Maybe.Nothing) {
                              return {
                                  width: 0,
                                  height: 0,
                                  isMobile: matches$prime
                              };
                          };
                          if (v1 instanceof Data_Maybe.Just) {
                              var height = Web_DOM_Element.clientHeight(v1.value0)();
                              var width = Web_DOM_Element.clientWidth(v1.value0)();
                              Effect_Console.log(Data_Number_Format.toStringWith(Data_Number_Format.fixed(4))(height) + (":" + Data_Number_Format.toStringWith(Data_Number_Format.fixed(4))(width)))();
                              return {
                                  width: Data_Int.floor(width),
                                  height: Data_Int.floor(height),
                                  isMobile: matches$prime
                              };
                          };
                          throw new Error("Failed pattern match at MoonLander (line 304, column 7 - line 310, column 80): " + [ v1.constructor.name ]);
                      }))(function (env) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              var $59 = {};
                              for (var $60 in st) {
                              ...
                              $59.env = (function () {
                                  var $56 = {};
                                  for (var $57 in s.env) {
                                      if ({}.hasOwnProperty.call(s.env, $57)) {
                                          $56[$57] = s["env"][$57];
                                      };
                                  };
                                  $56.width = env.width;
                                  $56.height = env.height;
                                  $56.isMobile = env.isMobile;
                                  return $56;
                              })();
                              return $59;
                          }))(function () {
              ...
              if (v instanceof HandleKeyDown) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                      var $64 = $$char === " ";
                      if ($64) {
                          return handleAction(dictMonadAff)(dictMonadAff.MonadEffect0())(HandleDown.value);
                      };
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  })())(function () {
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              ...
              if (v instanceof HandleKeyUp) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_UIEvent_KeyboardEvent.toEvent(v.value1))))(function () {
                      var $$char = Web_UIEvent_KeyboardEvent.key(v.value1);
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)((function () {
                          var $67 = $$char === " ";
                          if ($67) {
                              return handleAction(dictMonadAff)(dictMonadAff.MonadEffect0())(HandleUp.value);
                          };
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                      })())(function () {
                          return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              ...
              if (v instanceof HandleTouchStart) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_TouchEvent_TouchEvent.toEvent(v.value1))))(function () {
                      return handleAction(dictMonadAff)(dictMonadAff.MonadEffect0())(HandleDown.value);
                  });
              };
              if (v instanceof HandleTouchEnd) {
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Web_Event_Event.preventDefault(Web_TouchEvent_TouchEvent.toEvent(v.value1))))(function () {
                      return handleAction(dictMonadAff)(dictMonadAff.MonadEffect0())(HandleUp.value);
                  });
              };
              if (v instanceof HandleDown) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
                      if (s.game.gameStatus instanceof Playing) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              ...
                              $78.game = (function () {
                                  var $75 = {};
                                  for (var $76 in s.game) {
                                      if ({}.hasOwnProperty.call(s.game, $76)) {
                                          $75[$76] = s["game"][$76];
                                      };
                                  };
                                  $75.keyFlag = true;
                      ...
                      if (s.game.gameStatus instanceof Opening) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              ...
                              $84.game = (function () {
                                  var $81 = {};
                                  for (var $82 in s.game) {
                                      if ({}.hasOwnProperty.call(s.game, $82)) {
                                          $81[$82] = s["game"][$82];
                                      };
                                  };
                                  $81.gameStatus = Playing.value;
                                  $81.keyFlag = true;
                                  return $81;
                              })();
                              return $84;
                      ...
                      if (s.game.gameStatus instanceof GameOver) {
                          ...
                          throw new Error("Failed pattern match at MoonLander (line 351, column 9 - line 355, column 30): " + [ s.game.gameStatus.value1.constructor.name ]);
                      };
                      return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
                  });
              };
              if (v instanceof HandleUp) {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
                      if (s.game.gameStatus instanceof Playing) {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                              var $97 = {};
                              ...
                              $97.game = (function () {
                                  var $94 = {};
                                  for (var $95 in s.game) {
                                      if ({}.hasOwnProperty.call(s.game, $95)) {
                                          $94[$95] = s["game"][$95];
                                      };
                                  };
                                  $94.keyFlag = false;
                      ...
                      return Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Data_Functor["void"](Effect.functorEffect)(function __do() {
                          ...
                          if (v1 instanceof Data_Maybe.Just) {
                              ...
                              (function () {
                                  if (s.game.gameStatus instanceof Playing) {
                                      if (s.game.keyFlag) {
                                          ...
                                          throw new Error("Failed pattern match at MoonLander (line 406, column 13 - line 426, column 26): " + [ s.images.rocket.constructor.name ]);
                                      };
                                      return Data_Unit.unit;
                                  };
                                  return Data_Unit.unit;
                              ...
                              (function () {
                                  if (s.images.rocket instanceof Data_Maybe.Just) {
                                      ...
                                      var angle = (function () {
                                          if (s.game.gameStatus instanceof GameOver) {
                                              ...
                                              throw new Error("Failed pattern match at MoonLander (line 442, column 44 - line 444, column 40): " + [ s.game.gameStatus.value0.constructor.name ]);
                                          };
                                          return 0.0;
                                      })();
                                  ...
                                  throw new Error("Failed pattern match at MoonLander (line 433, column 7 - line 449, column 20): " + [ s.images.rocket.constructor.name ]);
                              })();
                              ...
                              throw new Error("Failed pattern match at MoonLander (line 487, column 7 - line 487, column 55): " + [ v2.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at MoonLander (line 373, column 7 - line 373, column 61): " + [ v1.constructor.name ]);
                      }));
                  });
              };
              throw new Error("Failed pattern match at MoonLander (line 247, column 16 - line 491, column 16): " + [ v.constructor.name ]);
          };
      };
  };
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.delay(Data_Time_Duration.Milliseconds(1000.0 / 60.0))))(function () {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s) {
                  ...
                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                      ...
                      $125.game = (function () {
                          var $122 = {};
                          for (var $123 in st.game) {
                              if ({}.hasOwnProperty.call(st.game, $123)) {
                                  $122[$123] = st["game"][$123];
                              };
                          };
                          $122.acceleration = acceleration;
                          $122.speed = speed;
                      ...
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(dictMonadAff)(dictMonadAff.MonadEffect0())(Draw.value))(function () {
                          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (s1) {
                              if (s1.game.gameStatus instanceof Playing) {
                                  var $129 = s1.game.altitude <= 0.0;
                                  if ($129) {
                                      var result = (function () {
                                          var $130 = s1.game.speed >= -2.0;
                                          if ($130) {
                                      ...
                                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                          ...
                                          $134.game = (function () {
                                              var $131 = {};
                                              for (var $132 in st.game) {
                                                  if ({}.hasOwnProperty.call(st.game, $132)) {
                                                      $131[$132] = st["game"][$132];
                                                  };
                                              };
                                              $131.gameStatus = new GameOver(result, Waiting.value);
                                              return $131;
                                          })();
                                          return $134;
                                      }))(function () {
                                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(handleAction(dictMonadAff)(dictMonadAff.MonadEffect0())(Draw.value))(function () {
                                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Effect_Aff.delay(Data_Time_Duration.Milliseconds(500.0))))(function () {
                                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                                                      ...
                                                      $140.game = (function () {
                                                          var $137 = {};
                                                          for (var $138 in s1.game) {
                                                              if ({}.hasOwnProperty.call(s1.game, $138)) {
                                                                  $137[$138] = s1["game"][$138];
                                                              };
                                                          };
                                                          $137.gameStatus = new GameOver(result, Ready.value);
                                                          return $137;
                                                      })();
                                                      return $140;
                                                  }))(function () {
